...
public class DirectionButton: UIView {
    ...
    weak public var tapDelegate: DirectionButtonDelegate?
    ...
    private lazy var centerButton: CenterButton = {
        ...
        tempView.setImage(UIImage.imageFromBundle(named: "btn_pause2"), for: .normal)
        tempView.setImage(UIImage.imageFromBundle(named: "btn_pause_s2"), for: .highlighted)
        self.addSubview(tempView)
        return tempView
    }()
